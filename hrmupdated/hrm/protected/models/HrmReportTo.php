...
class HrmReportTo extends CActiveRecord
{
	...
	public function checkSupervisor($emp_number) {
		
		$row = Yii::app()->db->createCommand("SELECT user_id  FROM hrm_report_to WHERE user_type = 'supervisor' and user_id=".$emp_number)->queryRow();
		return $row;
	}	
